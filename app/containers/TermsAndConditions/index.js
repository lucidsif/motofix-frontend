...
export class TermsAndConditions extends React.Component { // eslint-disable-line react/prefer-stateless-function
  render() {
    return (
      <div>
        <h1>
        Terms of Service for motofixes.com
        </h1>
        <p>
        Introduction
        </p>
        ...
        Iiii. Impersonates any person or entity, including any motofixes.com employees or representatives.
        </p>
        ...
        <p>
        All content and materials available on motofixes.com, including but not limited to text, graphics, website name, code, images and logos are the intellectual property of motofix, and are protected by applicable copyright and trademark law. Any inappropriate use, including but not limited to the reproduction, distribution, display or transmission of any content on this site is strictly prohibited, unless specifically authorized by motofix.
        </p>
        <p>
        Termination of Use
        </p>
        ...
        <p>
        UNLESS OTHERWISE EXPRESSED, motofix EXPRESSLY DISCLAIMS ALL WARRANTIES AND CONDITIONS OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO THE IMPLIED WARRANTIES AND CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.
        </p>
        <p>
        Contact Information
        </p>
